...
public class Supplier {
    ...
    public String getSuoolierBrankCode() {
        return suoolierBrankCode;
    }

    public void setSuoolierBrankCode(String suoolierBrankCode) {
        this.suoolierBrankCode = suoolierBrankCode == null ? null : suoolierBrankCode.trim();
    }
